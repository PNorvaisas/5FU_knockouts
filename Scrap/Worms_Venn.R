...
unw<-list('Whole Keio library'=all,'Unknown function'=subset(unicom,Unknown.function=='TRUE')$Gene,'MIC>5'=MIC25)
...
dev.copy2pdf(device=cairo_pdf,file=paste(odir,"/Venn_Worm-Bacteria_resistance_overlap.pdf",sep=''),width=9,height=9)
